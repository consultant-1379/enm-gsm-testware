...
public class CLIScriptExecutionOperator implements ScriptExecutionOperator {
    ...
    private static final String REMOTE_FOLDER_TAF_SCRIPTS_LOCATION = "/netsim/enm-gsm-testware/ERICTAFenmsimnetgsmbuild_CXP9036542/src/main/resources/";
    ...
    private static final String JENKINS_ENM_NI_SIMNET_JAR_FILE_SEARCH_TERM = "lib.*CXP9036542";

    /** Local zip file name for zipped embedded scripts */
    private static final String ZIP_FILE_NAME = "enm-gsm-testware.zip";
    ...
    public static boolean initialise() {
        ...
        try {
            ...
            CLICommandHelper.DEFAULT_COMMAND_TIMEOUT_VALUE = 3600L * 24 * 3;
    ...
    private static boolean setUpRemoteServerFolder(final CLICommandHelper cliComandHelper) {
        ...
        cliComandHelper.execute("mkdir -v -p /netsim/enm-gsm-testware/ERICTAFenmsimnetgsmbuild_CXP9036542/src/main/resources; chown -v netsim:netsim /netsim/enm-gsm-testware/ERICTAFenmsimnetgsmbuild_CXP9036542/src/main/resources");
    ...
    private static boolean copyScriptsFolderToRemoteServer(final CLICommandHelper cliComandHelper) {
        ...
        try {
            ...
            if (Pattern.compile("testware").matcher(currentPath).find()) {
                ...
                final String destUnzipFolderName = "enm-gsm-testware";
    ...
    public int verifyScriptExecution(final String command) {
        ...
        try {
            ...
            if (command.contains("simnet") && command.contains("startBuild.sh")) {
                String tmpCommand = command;
